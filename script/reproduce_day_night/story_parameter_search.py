...
from payoff_matrix import ACTIVITY_REGIMES, CYCLE_PERIOD, DEFAULT_ATTRACTION
from payoff_matrix import DEFAULT_DIFFUSION, DEFAULT_INITIAL_CENTERS
from payoff_matrix import DEFAULT_INITIAL_WIDTH, DEFAULT_REACTION_RATES
from payoff_matrix import build_config as build_payoff_config
from payoff_matrix import build_lighting_regime, run_all_cases
from payoff_replicator_analysis import simulate_replicator_dynamics
...
def parse_args():
    ...
    parser.add_argument(
        "--output-json",
        type=Path,
        help="Optional path where the ranked results are written as JSON.",
    )
