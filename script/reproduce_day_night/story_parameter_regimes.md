...
`script/reproduce_day_night/run_payoff_pipeline.sh` workflow.
...
`script/reproduce_day_night/output/Test2`.
...
script/reproduce_day_night/run_payoff_pipeline.sh \
  --output-dir script/reproduce_day_night/output/Test2 \
...
bash script/reproduce_day_night/run_payoff_pipeline.sh \
  --output-dir script/reproduce_day_night/output/story2_minimal \
  --python .venv/bin/python \
  --mean-x-axes cycle1,cycle2 \
...
```bash
bash script/reproduce_day_night/run_payoff_pipeline.sh \
  --output-dir script/reproduce_day_night/output/story2_candidate \
  --python .venv/bin/python \
  --mean-x-axes cycle1,cycle2 \
  --t-sunset 0.3 \
  --weights 1.0 1.0 \
