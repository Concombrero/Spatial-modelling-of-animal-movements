...
- `script/simulations/GameTheory/run_payoff_pipeline.sh`
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/full_pipeline_run
```
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/full_pipeline_population_integral \
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/full_pipeline_net_growth \
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/short_day_run \
  --t-sunset 0.35 \
  --weights 0.2 0.7
```
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/predator_day_advantage \
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/cycle_focus \
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/venv_run \
...
```bash
.venv/bin/python -m script.simulations.GameTheory.payoff_matrix \
  --run-config script/simulations/GameTheory/output/net_growth/Test1/run_config.json \
  --output-dir script/simulations/GameTheory/output/net_growth/Test1_recreated
```
...
```bash
bash script/simulations/GameTheory/run_payoff_pipeline.sh \
  --output-dir script/simulations/GameTheory/output/net_growth/Test1_pipeline_recreated \
  --run-config script/simulations/GameTheory/output/net_growth/Test1/run_config.json
```
...
```bash
.venv/bin/python -m script.simulations.GameTheory.payoff_weight_nash_heatmap \
  --run-config script/simulations/GameTheory/output/weight_nash/run_config.json \
  --output-dir script/simulations/GameTheory/output/weight_nash_recreated
```
...
```bash
.venv/bin/python -m script.simulations.GameTheory.payoff_weight_nash_heatmap \
  --output-dir script/simulations/GameTheory/output/weight_nash \
  --payoff-mode net-growth
```
...
```bash
.venv/bin/python -m script.simulations.GameTheory.payoff_weight_nash_strategy_table \
  script/simulations/GameTheory/output/weight_nash
```
