...
from script.simulations.GameTheory.payoff_matrix import (
    DEFAULT_ATTRACTION,
    DEFAULT_DIFFUSION,
...
from script.simulations.GameTheory.payoff_replicator_analysis import (
    MissingDependencyError,
    compute_nash_equilibria,
    require_nashpy,
)
from script.simulations.paths import ensure_directory, game_theory_output_path
...
def load_saved_weight_nash_run_config(config_path):
    ...
    if "payoff_config" not in payload:
        raise ValueError(
            ...
            "with script.simulations.GameTheory.payoff_matrix or "
